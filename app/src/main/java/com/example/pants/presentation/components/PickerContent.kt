...
import com.example.pants.presentation.ui.utils.animatedGradientTransition
...
internal fun PickerContent(
    ...
    Column(
        ...
        HuePicker(hue = selectedColor.hue, onHueChange = onHueChange) //animatedColor = animatedColor
    }
}
